...
-- Set the path for Python 2 executable
vim.g.python2_host_prog = '/usr/bin/python2'

-- Set the path for Python 3 executable
...
vim.api.nvim_set_keymap('n', '<leader>st', ':s/./̶&/g<CR>', { desc = '[S]trike [T]hrough and move to end' })
...
-- Enable letter incrementing with <C-a> and <C-x>
